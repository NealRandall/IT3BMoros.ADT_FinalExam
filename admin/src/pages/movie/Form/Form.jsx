...
const Form = () => {
  ...
  const handleSelectMovie = (movie) => {
    ...
    axios.get(`https://api.themoviedb.org/3/movie/${movie.id}/videos?language=en-US`, {
        headers: {
            Accept: "application/json",
            Authorization:  'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI4YjZkOGMwNDIwMWMyMzExNmVhMWMwOGNjMjgzMmZhMSIsIm5iZiI6MTczMzQ3OTU1Ny44NjgsInN1YiI6IjY3NTJjYzg1YWIzN2ZjZDNlODg1MjQ4ZiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.YDgGJNOa7I0T6U8m6EnP-uKXQPB4grzRiw_qunThR0Y',
        },
    })
    .then(response => {
